...
$.fn.dropdown.settings.templates = {
  ...
  dropdown: function(select) {
    ...
    $.each(select.values, function(index, option) {
      html += (option_type.disabled)
        ? '<div class="disabled item" data-value="' + option_type.value + '">' + option_type.name + '</div>'
        : '<div class="item" data-value="' + option_type.value + '">' + option_type.name + '</div>'
      ;
    });
    html += '</div>';
    return html;
  ...
  menu: function(response, fields) {
    ...
    $.each(values, function(index, option) {
      html += '<div class="item" data-value="' + option_type[fields.value] + '">' + option_type[fields.name] + '</div>';
    });
    return html;
  },
