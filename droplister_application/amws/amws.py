...
class MWS(object):
    ...
    def __init__(self, access_key, secret_key, account_id, region='US', domain='', uri="", version="", proxy_host=None, host_port=None):
    ...
    def make_request(self, extra_data, method="GET", **kwargs):
        ...
        try:
            ...
            proxyDict = {"http": "http://127.0.0.1:3128", "https": "https://127.0.0.1:3128", "ftp": "ftp://127.0.0.1:3128"}
            print kwargs.get('body')
            response = request(method, url, data=kwargs.get('body', ''), headers=headers, proxies=proxyDict)
