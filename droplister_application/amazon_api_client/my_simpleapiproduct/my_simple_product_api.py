...
from droplister_application.amazon_api_client.my_bottlenose import my_bottlenose
...
class AmazonAPI(object):
    def __init__(self, aws_key, aws_secret, aws_associate_tag, **kwargs):
        ...
        self.api = my_bottlenose.Amazon(aws_key, aws_secret, aws_associate_tag, **kwargs)
