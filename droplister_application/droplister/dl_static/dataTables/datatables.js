 ...
 *   https://datatables.net/download/#dt/jq-2.2.3,dt-1.10.12,cr-1.3.2,fc-3.2.2,fh-3.1.2,r-2.1.0,rr-1.1.2,se-1.2.0
 *
 * Included libraries:
 *   jQuery 2.2.3, DataTables 1.10.12, ColReorder 1.3.2, FixedColumns 3.2.2, FixedHeader 3.1.2, Responsive 2.1.0, RowReorder 1.1.2, Select 1.2.0
 */
...
jQuery.ajaxSetup( {
	accepts: {
		script: "text/javascript, droplister_application/javascript, " +
			"droplister_application/ecmascript, droplister_application/x-ecmascript"
	},
	contents: {
	...
	var callbackName, overwritten, responseContainer,
		jsonProp = s.jsonp !== false && ( rjsonp.test( s.url ) ?
			...
			typeof s.data === "string" &&
				( s.contentType || "" )
					.indexOf( "droplister_application/x-www-form-urlencoded" ) === 0 &&
...
(function( $, window, document, undefined ) {
	 ...
	 * given table, including configuration, data and current droplister_application of the
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/jq-2.2.3,dt-1.10.12,cr-1.3.2,fc-3.2.2,fh-3.1.2,r-2.1.0,rr-1.1.2,se-1.2.0",
