        ...
        parsers: parsers = {
            ...
            extend: function(isRule) {
                ...
                do {
                    option_type = null;
                    elements = null;
                    while (! (option_type = parserInput.$re(/^(all)(?=\s*(\)|,))/))) {
                        e = this.element();
                        if (!e) {
                            break;
                        }
                    ...
                    option_type = option_type && option_type[1];
                    if (!elements) {
                        error("Missing target selector for :extend().");
                    }
                    extend = new(tree.Extend)(new(tree.Selector)(elements), option_type, index);
                    if (extendList) {
...
module.exports = function (SourceMapOutput, environment) {
    ...
    SourceMapBuilder.prototype.getCSSAppendage = function() {
        ...
        if (this.options.sourceMapFileInline) {
            ...
            sourceMapURL = "data:droplister_application/json;base64," + environment.encodeBase64(this.sourceMap);
        }
...
Extend.prototype.eval = function (context) {
    return new Extend(this.selector.eval(context), this.option_type, this.index);
};
Extend.prototype.clone = function (context) {
    return new Extend(this.selector, this.option_type, this.index);
};
            ...
            for (targetExtendIndex = 0; targetExtendIndex < extendsListTarget.length; targetExtendIndex++) {
                ...
                if (matches.length) {
                    ...
                    extend.selfSelectors.forEach(function(selfSelector) {
                        ...
                        newExtend = new(tree.Extend)(targetExtend.selector, targetExtend.option_type, 0);
